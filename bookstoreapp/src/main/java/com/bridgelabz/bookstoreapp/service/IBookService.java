...
public interface IBookService {
     ...
     */
    String deleteBook(int id, String token);
     ...
     */
    String updateBookPrice(int id, String token, BookPriceDTO bookPriceDTO);
     ...
     */
    String updateBookQuantity(int id, String token, BookQuantityDTO bookQuantityDTO);
}
